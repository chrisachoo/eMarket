  ...
  return (
    <>
      <div className="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
        <Link to='/' className="text-2xl font-bold text-gray-800">eMarket</Link>
      ...
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div className="px-4 pt-8">
          ...
          <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
            ...
            {items.map(element => {
              return (
                <div className="flex flex-col rounded-lg bg-white sm:flex-row" key={element.id}>
                  <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src={element.picture_url} alt="" />
                  <div className="flex w-full flex-col px-4 py-4">
                    <span className="font-semibold">{element.description}</span>
                    <span className="float-right text-gray-400">{element.name}</span>
                    <p className="text-lg font-bold">R {numberFormatter.format(element.price)}</p>
                  </div>
                </div>
              )
            })}
